...
import { CHANNEL_CAPTURE_CONTAINER_CSS_CLASSES, CHANNEL_CAPTURE_CONTAINER_CSS_IDS, DANGER_ICON, SLIDEDOWN_CSS_IDS } from "./constants";
...
export default class ChannelCaptureContainer {
    ...
    async loadPhoneLibraryScripts() {
        ...
        const promise1 = new Promise(resolve => { script1.onload = () => { resolve(); }; });
        const promise2 = new Promise(resolve => { script2.onload = () => { resolve(); }; });
